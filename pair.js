...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            email: 'emmanuelboss2244@gmail.com', // Your Mega A/c Email Here
            password: 'emmanuel266' // Your Mega A/c Password Here
        }).ready;
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'SNIPER-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com/channel/0029Vb5sZ0dLY6dDyDEsbp3J) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [Malvin King GitHub Repo](https://github.com/Xrhvvbmncxzfbmvxn/SNIPER-session)  

🚀 _Thanks for choosing SNIPER-MD— Let the automation begin!_ ✨`;
